use crate::{
    ...
    EvaluationDomain, FieldChip, ForeignEccChip, ForeignEccConfig, HashInstructions, IVC_ONE_NAME,
    Jubjub, Layouter, NB_ARITH_COLS, NB_ARITH_FIXED_COLS, NB_EDWARDS_COLS, NB_POSEIDON_ADVICE_COLS,
    ...
    Value, VerifierGadget, ZeroInstructions,
    ivc_one::{
        C, CBase, F, K, NG, S,
        state::{
            AssignedGlobal, AssignedState, AssignedWitness, Global, State, Witness,
            fixed_base_names,
        },
    },
    nb_foreign_ecc_chip_columns, verifier,
};
use ff::Field;
use group::Group;
...
pub struct IvcConfig {
    ...
    bls12_381_config: ForeignEccConfig<C>,
