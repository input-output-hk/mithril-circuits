use crate::{
    Accumulator, BinaryInstructions, Circuit, ComposableChip, ConstraintSystem, Error,
    EvaluationDomain, KZGCommitmentScheme, Layouter, PublicInputInstructions, SimpleFloorPlanner,
    Value, VerifyingKey,
    ivc_one::{
        E, F, K, S,
